...
This project is deals with the E-Commerce website. In this project frontend is 
creating by using Angular and Backend is creating by using C#, We are using a 
